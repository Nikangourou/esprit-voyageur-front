...
export default function Chat() {
  ...
  const altGenerateAllImages = () => {
    ...
    const tl = gsap
      ...
      .call(async () => {
        const trueContent =
          "The snowy slopes of Switzerland became an unexpected theater of mishap for a young student on their first skiing expedition. Nervous and uninitiated, the young skier decided ambitiously to face all the trails without using any ski lifts, inadvertently plunging towards a challenging red-green icy slope. Gliding with uncontrollable speed, the novice’s adventure took a sudden turn as they collided with an unsuspecting elderly lady also enjoying her day on the slopes. The impact drew stares and murmurs of disapproval from surrounding skiers, marking the skier’s embarrassment as the air hung cold with tension. A ski patrol swiftly intervened, aiding the elderly lady, while the young skier stood alone, engulfed by a deep sense of embarassment and isolation, reflecting on the steep learning curve of life and ski slopes alike.";
        const falseContent =
         "In 2022, I went on a ski trip with friends to Val Cenis where there was a unique attraction on one of the slopes—a speed radar that allowed skiers to know how fast they were going. Excited about the challenge, each of my friends and I took turns trying to outdo each other. I was the last one to go down the slope. Surprisingly, despite considering myself a beginner and feeling slightly nervous, I ended up having the highest speed among my group, which led to shocked reactions from my friends. It wasn't until later during a casual evening gathering that one of my friends accidentally revealed that he had tampered with the radar as a practical joke, making my run appear faster than it actually was. This revelation turned the shock into laughter and disbelief, adding a humorous twist to what was already a memorable day on the slopes. The crisp mountain air, the thrill of the descent, and the laughter shared among friends made this day unforgettable.";
        await generateImg(
          apiUrl,
          trueContent,
          gameId,
